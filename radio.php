...
crt() . ']
    ...
    <input type="text" name="darilink" class="up" placeholder="">&nbsp;<input type="text" name="namalink" class="up" size="5" placeholder=""><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
    </form>';
